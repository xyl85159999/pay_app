...
class TongjiDetailModel extends ViewStateRefreshListModel {
  ...
  Future<List> loadData({int? pageNum}) async {
    ...
    return await serviceVossTj.getTransactionDetailLogList(
        pageNum ?? 1, 20, bagName ?? '',
        bt: getTime(startDate), et: getTime(endDate, isEnd: true));
  }
