...
class Endpoint extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(Endpoint) updates) => super.copyWith((message) => updates(message as Endpoint));
...
class PingMessage extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(PingMessage) updates) => super.copyWith((message) => updates(message as PingMessage));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class PongMessage extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(PongMessage) updates) => super.copyWith((message) => updates(message as PongMessage));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class FindNeighbours extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(FindNeighbours) updates) => super.copyWith((message) => updates(message as FindNeighbours));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Neighbours extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(Neighbours) updates) => super.copyWith((message) => updates(message as Neighbours));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class BackupMessage extends $pb.GeneratedMessage {
  ...
  $pb.GeneratedMessage copyWith(void Function(BackupMessage) updates) => super.copyWith((message) => updates(message as BackupMessage));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
