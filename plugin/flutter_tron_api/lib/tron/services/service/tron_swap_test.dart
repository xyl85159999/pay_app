...
void testGetTrxBalance() async {
  ...
  double result = await TronSwap().getTrxBalance(userAddress);
...
void testGetTrc20Balance() async {
  ...
  double result =
      await TronSwap().getTrc20Balance( userAddress, tokenAddress);
...
void testAllowance() async {
  ...
  String result = await TronSwap()
      .allowance( userAddress, swapTokenAddress, flashSwapAddress);
...
void testApprove() async {
  ...
  bool result = await TronSwap().approve(
       userAddress, privateKey, swapTokenAddress, flashSwapAddress);
...
void testTrxToTokenSwap() async {
  ...
  bool result = await TronSwap().trxToTokenSwap( userAddress,
